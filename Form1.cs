...
namespace ScreenCapturer
{
    public partial class Form1 : Form
    {
        ...
        private void setWin(Control _control) 
        {
            var fcapture = new FScreenShow(0, _control.Location.X, _control.Location.Y + SystemInformation.CaptionHeight, _control.Location.X + _control.Width, _control.Location.Y + _control.Height + SystemInformation.CaptionHeight);
        ...
        {
            setWin(this.btn_capture);
            //var fcapture = new FScreenShow(0,this.btn_folder.Location.X,this.btn_folder.Location.Y+ SystemInformation.CaptionHeight, this.btn_folder.Location.X+this.btn_folder.Width, this.btn_folder.Location.Y + this.btn_folder.Height+ SystemInformation.CaptionHeight);
